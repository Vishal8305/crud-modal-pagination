...
const Table = ({data,setData, records}) => {
  ...
  const handler1 = (cData) =>{
    ...
    setImage(cData.image)
    setTitle(cData.title)
    setPrice(cData.price)
  }
  ...
  return (
    ...
    {isOpen1 && <Model2 setIsOpen={setIsOpen1} cData={currentData} data={data} setData={setData} title={title} image={image} price={price}/>}
    </>
  )
}
